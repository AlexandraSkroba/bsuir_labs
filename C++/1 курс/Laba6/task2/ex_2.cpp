// Лабораторная 6, задача 2(вариант 10). Выполнена: Скроба А.П.
/* В тексте найти и вывести на экран все слова максимальной и минимальной длины. */
#include<iostream>
#include<Windows.h>
...
int main() {
	...
	std::cout << "Программа выводит на экран все слова максимальной и минимальной длины.\nВведите строку:";
	int maxN = 2;
