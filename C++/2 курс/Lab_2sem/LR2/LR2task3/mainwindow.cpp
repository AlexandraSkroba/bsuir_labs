    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->numA->setValidator(new QRegularExpressionValidator(QRegularExpression("^[0-9.-]{10}&")));
    ui->numB->setValidator(new QRegularExpressionValidator(QRegularExpression("^[0-9.-]{10}&")));
    ui->numC->setValidator(new QRegularExpressionValidator(QRegularExpression("^[0-9.-]{10}&")));
    ui->numD->setValidator(new QRegularExpressionValidator(QRegularExpression("^[0-9.-]{10}&")));
    ui->numE->setValidator(new QRegularExpressionValidator(QRegularExpression("^[0-9.-]{10}&")));
}
