...
Application::Application(std::string FilePath): filePath(FilePath) {
    ...
    player  = new Player(filePath, 0, 0, 240, 324, 0, 4, map, playerObject.rect.left, playerObject.rect.top, 100, 0.2);
...
void Application::createEnemyList() {
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 1312, 896, 100, 0.10, 0.35, 400, 1000  - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 2144, 800, 100, 0.02, 0.35, 400, 96    - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 3264,832, 100, 0.02, 0.35, 400, 96    - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 3392,192, 100, 0.02, 0.35, 400, 128   - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 4320, 512, 100, 0.02, 0.35, 400, 1000   - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 5440, 895, 100, 0.02, 0.35, 400, 64   - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 6080, 832, 100, 0.02, 0.35, 400, 64   - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 8256, 768, 100, 0.02, 0.35, 400, 1000   - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 10432, 896, 100, 0.02, 0.35, 400, 32   - 0.258064516 * 234, 0.258064516, 0.258064516));
    enemyList.push_back(new Enemy (filePath, 0, 0, 234, 372, 0, 4, map, 11040, 800, 100, 0.02, 0.35, 400, 128   - 0.258064516 * 234, 0.258064516, 0.258064516));
