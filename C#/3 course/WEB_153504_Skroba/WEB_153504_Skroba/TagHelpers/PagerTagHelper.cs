...
namespace WEB_153504_Skroba.TagHelpers
{
    ...
    public class PagerTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var prevUrl = IsAdmin ? prevUrlAdmin : _linkGenerator.GetUriByAction(_httpContextAccessor.HttpContext, "index", "tea", new { pageNo = prev });
            ...
            for (int i = 1; i <= TotalPages; i++)
            {
                ...
                var url = IsAdmin ? urlAdmin : _linkGenerator.GetUriByAction(_httpContextAccessor.HttpContext, "index", "tea", new { pageNo = i });
            ...
            var nexrUrl = IsAdmin ? nextUrlAdmin : _linkGenerator.GetUriByAction(_httpContextAccessor.HttpContext, "index", "tea", new { pageNo = next });
